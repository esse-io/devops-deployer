...
{%- set env_db_name = salt['pillar.get']('postgresql:sharpen_db_name') + ',' + salt['pillar.get']('postgresql:hive_db_name') + ',' + salt['pillar.get']('postgresql:gitlab_db_name') + ',' + salt['pillar.get']('postgresql:gerrit_db_name') -%}
